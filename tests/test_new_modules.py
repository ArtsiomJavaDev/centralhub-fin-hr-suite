...
import crm.formatter as formatter
...
class TestResolveUzRates:
    ...
    def test_special_chorobowe_pesel_excel_fallback(self, monkeypatch: pytest.MonkeyPatch):
        pesel = "90010112345"
        monkeypatch.setattr(formatter, "_SPECIAL_CHOROBOWE_PESELS", frozenset({pesel}))
        warnings: list[str] = []
        marker, rates = _resolve_uz_rates(
