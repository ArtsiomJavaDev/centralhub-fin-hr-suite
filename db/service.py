...
from privacy_lists import UMOWY_EXPORT_EXCLUDE_PESELS
...
# PESEL excluded from the main UZ/UD export. The real list is loaded from local
# `_sensitive_lists.py` and must never be committed.
_UMOWY_EXPORT_EXCLUDE_PESEL: frozenset[str] = UMOWY_EXPORT_EXCLUDE_PESELS
