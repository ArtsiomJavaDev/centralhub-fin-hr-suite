...
from privacy_lists import SPECIAL_CHOROBOWE_PESELS
...
UBEZPIECZENIA_SPECIAL_PESELS: set[str] = set(SPECIAL_CHOROBOWE_PESELS)
# Zlecenie: PESELs that receive Składka chorobowa 2.45% when no CRM flag exists.
UMOWY_SPECIAL_PESELS: set[str] = set(SPECIAL_CHOROBOWE_PESELS)
